$(document).ready(function () {
  ...
  // tabs changes
  $(".tab-section:nth-of-type(1)").show();
  $(".bar a").on("click", function (event) {
    var target = $(this).attr("id");
    console.log(target);
    $(".tab-section").hide();
    $("[data-tabsection=" + target + "]").show();
  });
  // scroll to top
  $(".btn").click(function scrollToTop() {
    window.scrollTo(0, 0); //defined x, y -coordinates.
  });
});
...
$(document).ready(function () {
  $(".accordions .accordion button ").click(function () {
    ...
    // console.log($(".accordion").hasClass("_active"));
